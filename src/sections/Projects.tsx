    ...
    return (
        <section className="pb-16 lg:py-24">
            <div className="container">
                ...
                <p className="text-center md:text-lg text-white/60 mt-4 max-w-md mx-auto">See how I transformed concepts
                    into engaging digital
                    experiences.</p>
                                ...
                                <div className="lg:pb-16">
                                    ...
                                    <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                                        {project.results.map((result) => (
                                            <li className="flex gap-2 text-sm md:text-base text-white/20">
